<template>
	<header>
		<div class="filter" v-if="roles.length > 0">
			<div class="filter__item" v-for="role in roles" :key="role">
		...
		<div v-for="card in data" :key="card.id" class="card">
			...
			<div class="card-information">
				...
				<div class="right">
					...
					<div class="filter" @click="roles.push(card.role)">
						{{ card.role }}
					</div>
					<div class="filter" @click="roles.push(card.level)">
						{{ card.level }}
					</div>
					<div
