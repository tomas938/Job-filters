	...
	<main>
		<div v-for="card in data" :key="card.id" class="card">
			...
			<div class="card-information">
				...
				<!-- {{ card.languages ? lang(card.languages, card.role, card.level) : "" }} -->
				<div class="right">
					<div class="filter">{{ card.role }}</div>
					<div class="filter">{{ card.level }}</div>
					<div v-for="lang in card.languages" :key="lang" class="filter">
						{{ lang }}
					</div>
				</div>
			</div>
